...
//		System.out.println(msg.substring(4, 5));
	...
	public static int[] solution(String msg) {
        ...
        int dicIdx = 1;
        for(int i = 65; i <= 90; i++) {
        	dictionary.put(Character.toString(i), dicIdx++);
        }
        ...
        String searchStr = "";
        while(true) {
        	searchStr = msg.substring(start, end);
        	if(dictionary.get(searchStr) != null) {
        		if(end == msg.length()) {
        			answerList.add(dictionary.get(msg.substring(start, end)));
        			break;
        		}
        		//사전에 있음
        		end++;
        		...
        		//출력
        		answerList.add(dictionary.get(msg.substring(start, end - 1)));
        		//사전 등록
        		dictionary.put(searchStr, dicIdx++);
        		start = end - 1;
        	}
        }
